  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Shagis Friseursalon</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Shagis Friseursalon in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Shagis Friseursalon | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Shagis Friseursalon | Premium Barbershop Berlin" />
        <meta
